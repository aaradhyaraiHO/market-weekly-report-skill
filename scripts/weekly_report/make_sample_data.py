        ...
        for nm, sig, direction in anchors:
            ...
            bucket1.append({
                ...
                "evidence": {
                    ...
                    "sdlw_pct": round(rng.uniform(20, 45), 1),
                    "wow_pct": round(rng.uniform(18, 40), 1),
                    "persistence_days": rng.choice([3, 4, 5]),
                    "cv": round(rng.uniform(0.18, 0.42), 2),
                },
        ...
        for d in headlines["top_drops"][:2]:
            ...
            bucket1.append({
                ...
                "evidence": {
                    ...
                    "sdlw_pct": round(-rng.uniform(25, 40), 1),
                    "wow_pct": round(-rng.uniform(31, 48), 1),
                    "persistence_days": rng.choice([3, 4]),
                    "cv": round(rng.uniform(0.2, 0.45), 2),
                },
                "paid_contribution_pct": w0["paid_contribution_pct"],
