...
def build_market(market_slug: str, w0_start: dt.date, *, with_availability=True) -> dict:
    ...
    try:
        ...
        print(f"  ⚠ [{market}] variant children SKIPPED — {reason}; "
              "existing TGID/resource drawer data and the weekly report remain available.")
    try:
    ...
    # 12-week ce_weekly_funnel scan that hit 320 GB/run — reverted 2026-07-21.)
